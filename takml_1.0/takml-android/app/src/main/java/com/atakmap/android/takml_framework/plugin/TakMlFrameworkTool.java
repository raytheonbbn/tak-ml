 ...
 */
public class TakMlFrameworkTool extends Tool implements ToolDescriptor {

    public static final String TAG = TakMlFrameworkTool.class.getSimpleName();

    private final Context context;
    private LayerDrawable _icon;


    public TakMlFrameworkTool(final Context context) {
        ...
        AtakBroadcast.getInstance().registerReceiver(br, new AtakBroadcast.DocumentedIntentFilter("com.atakmap.android.takml_framework.plugin.iconcount"));
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2,
        ...
        Intent i = new Intent(
                "com.atakmap.android.takml_framework.SHOW_FRAMEWORK_STANDUP");
