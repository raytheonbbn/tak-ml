...
public class DL4JClassifierRogerPlugin implements StartablePlugin {

    private static final Logger logger = LoggerFactory.getLogger(DL4JClassifierRogerPlugin.class);
    ...
    public void start() {
        ...
        if (!this.mxf.register(DL4JClassifierPlugin.class))
    ...
    @Override
    public void stop() {
        if (!this.mxf.deregister(DL4JClassifierPlugin.class))
