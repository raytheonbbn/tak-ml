...
public class EditTakmlModelUIRequest {
    ...
    public EditTakmlModelUIRequest() {
    }

    public EditTakmlModelUIRequest(MultipartFile model, String requesterCallsign, boolean runOnTakmlServer) {
        this.model = model;
