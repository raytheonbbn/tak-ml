...
import com.atakmap.android.takml.mx_framework.plugin.TFLitePlugin;
...
public class TFLitePluginMapComponent extends DropDownMapComponent {

    private static final String TAG = TFLitePluginMapComponent.class.getSimpleName();
    ...
    private void register() {
        if (!mxf.register(TFLitePlugin.class)) {
    ...
    protected void onDestroyImpl(Context context, MapView view) {
        if (!this.mxf.deregister(TFLitePlugin.class))
