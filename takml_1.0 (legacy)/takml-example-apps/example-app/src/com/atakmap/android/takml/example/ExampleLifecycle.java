...
package com.atakmap.android.takml.example;
...
import com.atakmap.android.takml.ExampleMapComponent;
...
public class ExampleLifecycle implements Lifecycle {
    ...
    private final static String TAG = ExampleLifecycle.class
            .getSimpleName();

    public ExampleLifecycle(Context ctx) {
    ...
    public void onCreate(final Activity arg0,
        ...
        ExampleLifecycle.this.overlays
                .add(new ExampleMapComponent());

        activity = arg0;

        // create components
        Iterator<MapComponent> iter = ExampleLifecycle.this.overlays
                .iterator();
        MapComponent c;
        while (iter.hasNext()) {
            c = iter.next();
            try {
                c.onCreate(ExampleLifecycle.this.pluginContext,
                        arg0.getIntent(),
                        ExampleLifecycle.this.mapView);
            } catch (Exception e) {
                Log.w(TAG,
