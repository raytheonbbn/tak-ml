...
import com.atakmap.android.takml.utils.Utils;

public abstract class ViewTableReceiver extends DropDownReceiver implements DropDown.OnStateListener {
    // ** TODO: For the time being, I specify every color as a static int.
    // ** TODO: It would be better to specify the color using R.color, but unfortunately,
    // ** TODO: I couldn't get that to work. When I debugged the app, it seemed like
    // ** TODO: we were using the correct Context, but the 'color' information was 'collected'.
    // ** TODO: Other information, like the OSPPRE logo, was still completely available.
    ...
    public ViewTableReceiver(MapView mapView, Context context) {
        ...
        pxLeft = Utils.dpTopx(pluginContext, 10);
        pxTop = Utils.dpTopx(pluginContext, 10);
        pxRight = Utils.dpTopx(pluginContext, 10);
        pxBottom = Utils.dpTopx(pluginContext, 10);
    }
