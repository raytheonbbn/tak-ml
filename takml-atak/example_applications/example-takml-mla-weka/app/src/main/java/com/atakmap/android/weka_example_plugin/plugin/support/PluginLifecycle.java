...
package com.atakmap.android.weka_example_plugin.plugin.support;
 ...
 */
@Deprecated
abstract public class PluginLifecycle implements Lifecycle {
    ...
    public PluginLifecycle(Context ctx, MapComponent component) {
