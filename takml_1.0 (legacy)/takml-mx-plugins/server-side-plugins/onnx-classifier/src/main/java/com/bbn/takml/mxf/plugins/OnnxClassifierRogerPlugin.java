...
public class OnnxClassifierRogerPlugin implements StartablePlugin {

    private static final Logger logger = LoggerFactory.getLogger(OnnxClassifierRogerPlugin.class);
    ...
    public void start() {
        ...
        if (!this.mxf.register(OnnxClassifierPlugin.class))
    ...
    @Override
    public void stop() {
        if (!this.mxf.deregister(OnnxClassifierPlugin.class))
