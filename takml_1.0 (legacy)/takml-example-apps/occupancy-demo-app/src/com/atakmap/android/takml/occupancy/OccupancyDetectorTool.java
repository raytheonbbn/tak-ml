...
public class OccupancyDetectorTool extends Tool implements ToolDescriptor {

    private final Context context;

    public OccupancyDetectorTool(Context context) {
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2,
        ...
        Intent i = new Intent(
                OccupancyDetectorDropDownReceiver.SHOW_PLUGIN);
