...
public class WekaClassifierRogerPlugin implements StartablePlugin {

    private static final Logger logger = LoggerFactory.getLogger(WekaClassifierRogerPlugin.class);
    ...
    public void start() {
        ...
        if (!this.mxf.register(WekaClassifierPlugin.class))
    ...
    @Override
    public void stop() {
        if (!this.mxf.deregister(WekaClassifierPlugin.class))
