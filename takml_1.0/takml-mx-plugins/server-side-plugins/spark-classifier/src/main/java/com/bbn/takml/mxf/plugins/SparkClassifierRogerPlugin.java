...
public class SparkClassifierRogerPlugin implements StartablePlugin {

    private static final Logger logger = LoggerFactory.getLogger(SparkClassifierRogerPlugin.class);
    ...
    public void start() {
        ...
        if (!this.mxf.register(SparkClassifierPlugin.class))
    ...
    @Override
    public void stop() {
        if (!this.mxf.deregister(SparkClassifierPlugin.class))
