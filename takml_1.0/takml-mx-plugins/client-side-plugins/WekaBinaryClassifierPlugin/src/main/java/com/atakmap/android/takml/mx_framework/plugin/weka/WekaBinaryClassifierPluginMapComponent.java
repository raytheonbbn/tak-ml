...
package com.atakmap.android.takml.mx_framework.plugin.weka;
...
import com.atakmap.android.takml.mx_framework.plugin.weka.binaryclassifier.WekaBinaryClassifierPlugin;
import com.atakmap.coremap.log.Log;
import com.atakmap.android.takml.mx_framework.plugin.weka.binaryclassifier.R;
...
public class WekaBinaryClassifierPluginMapComponent extends DropDownMapComponent {

    private static final String TAG = WekaBinaryClassifierPluginMapComponent.class.getSimpleName();
    ...
    private void register() {
        if (!this.mxf.register(WekaBinaryClassifierPlugin.class)) {
    ...
    protected void onDestroyImpl(Context context, MapView view) {
        if (!this.mxf.deregister(WekaBinaryClassifierPlugin.class))
