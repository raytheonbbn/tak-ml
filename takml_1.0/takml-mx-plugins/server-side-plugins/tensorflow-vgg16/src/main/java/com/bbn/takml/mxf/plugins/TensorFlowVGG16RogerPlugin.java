...
public class TensorFlowVGG16RogerPlugin implements StartablePlugin {

    private static final Logger logger = LoggerFactory.getLogger(TensorFlowVGG16RogerPlugin.class);
    ...
    public void start() {
        ...
        if (!this.mxf.register(TensorFlowVGG16Plugin.class))
    ...
    @Override
    public void stop() {
        if (!this.mxf.deregister(TensorFlowVGG16Plugin.class))
