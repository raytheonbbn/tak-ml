...
import com.atakmap.android.takml.sensor.SensorExamplesDropDownReceiver;
...
public class SensorExamplesTool extends Tool implements ToolDescriptor {

    private final Context context;

    public SensorExamplesTool(Context context) {
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2,
        ...
        Intent i = new Intent(
                SensorExamplesDropDownReceiver.SHOW_PLUGIN);
